...
public final class DevicePermission extends BasicPermission {
	...
	public boolean implies(Permission p) {
		...
		// FIXME to be verified whether this is the right way to understand
		// which constructor has been used.
		// in theory not: the same filter could have been used also with the
		// other constructor
		...
		// FIXME how do you understand if a filter implies another ? Is this the
		// right way ?
		// This way of verifying the implementation depends on HOW it has been
		// decided to implement the constructor
		// (with device as parameter, that is, including the service UID as
		// filter)
 ...
 * 
 * FIXME ispirato da
 * http://www.massapi.com/source/jdk1.6.0_17/src/javax/management
 * /MBeanServerPermission.java.html
 * 
 * @serial include
 */
